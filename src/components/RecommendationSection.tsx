   ...
   <section id="certifications" className="bg-black text-white py-10 sm:py-12 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {recommendations.map((rec) => (
            <div
              key={rec.id}
              className="border border-gray-800 bg-gradient-to-b from-zinc-900/40 to-black p-6 sm:p-8 rounded-2xl transition-transform duration-300 hover:-translate-y-1 hover:border-lime-400 hover:shadow-[0_0_25px_-8px_rgba(163,255,88,0.5)]"
            >
              {/* Header with profile */}
              ...
              <div className="mt-6 flex items-center justify-between">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 border border-lime-400 rounded-full text-lime-400 hover:bg-lime-400 hover:text-black text-xs sm:text-sm font-medium transition-colors"
                >
